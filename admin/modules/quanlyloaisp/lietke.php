...
<table width="90%" style="margin: auto;margin-top: 10px;text-align: center;border-collapse: collapse;">
	...
	<?php 
	 ...
	 ?>
				<tr class="doimaudong">
					...
					<td>
						<a onclick="return confirm('Bạn có thực sự muốn xóa không?');" href="modules/quanlyloaisp/xuly.php?id_loaisp=<?php echo $dong['id_loaisp'] ?>"><img src="images/delete1.png" alt="">
						</a>
					</td>
				</tr>
	<?php 
	...
	?>		
			<tr>
					...
					<td>
						<a onclick="return confirm('Bạn có thực sự muốn xóa không?');" href="modules/quanlyloaisp/xuly.php?xoaloaisp=loaisp&id_loaisp=<?php echo $dong['id_loaisp'] ?>"><img src="images/delete1.png" alt="">
						</a>
					</td>
				</tr>
			<?php 
