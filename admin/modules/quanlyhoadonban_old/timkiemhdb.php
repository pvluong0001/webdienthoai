 ...
 <table width="99%" style="margin: auto;margin-top: 10px;text-align: center;border-collapse: collapse;">
	...
	<?php 
 	...
 	<tr class="doimaudong">
		...
		<td>
			<a onclick="return confirm('Bạn có thực sự muốn xóa không?');" href="modules/quanlyhoadonban/xuly.php?xoahoadonban=hoadonban&id_hdb=<?php echo $dong_hoadonban['id_hdb'] ?>">
				<img src="images/delete1.png" alt="">
			</a>
		</td>
		<td>
			<a href="../admin/index.php?quanly=quanlyhoadonban&ac=chitiethoadonban&id_hdb=<?php echo $dong_hoadonban['id_hdb'] ?>">Chi tiết
			</a>
		</td>
 	</tr>
 	<?php 
 	...
 	<tr>
		...
		<td>
			<a href="../admin/index.php?quanly=quanlyhoadonban&ac=chitiethoadonban&id_hdb=<?php echo $dong_hoadonban['id_hdb'] ?>">Chi tiết</a>
		</td>
 	</tr>
 	<?php
 			}
